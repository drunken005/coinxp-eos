...
class CoinXPEos {
    ...
    constructor() {
        ...
        this.address = new Address(config.account, this.options, this.addressContract);
        this.deposit = new DepositTx(config.account, this.options, this.depositTxContract);
        this.withdraw = new Withdraw(config.account, this.options, this.withdrawContract);
    }
